                                        ...
                                        <tbody>
                                            @foreach ($tapel as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->tempatbagiraport ? $item->tempatbagiraport : '-' }}</td>
                                                    <td>
                                                      {{ $item->tanggalbagiraport ? Carbon::createFromFormat('Y-m-d', $item->tanggalbagiraport)->locale('id')->isoFormat('D MMMM YYYY') : '-'}}
                                                    </td>
                                                    <td>
