                                            ...
                                            @foreach ($guru as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('dataguru.edit', $item->id) }}" type="button"
                                                        ...
                                                        @elseif (count($ekstrakurikuler->where('guru_id', $item->id)) > 0)
                                                        <button type="button"
                                                            class=" btn btn-danger pb-1 pt-0 px-2 d-inline"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#modalGagalDelete/{{ $item->id }}">
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('dataguru.destroy', $item->id) }}"
                                                                            ...
                                                                            <table>
                                                                                <tr class="border-bottom">
                                                                                  <div class="text-center mb-3">
                                                                                    ...
                                                                                    src="/img/{{ $item->foto ?? 'default.jpg' }}" style="object-fit: fill"
    ...
    <div class="modal fade" id="importData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title poppins fw-semibold" id="exampleModalLabel">Import Data Guru</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
