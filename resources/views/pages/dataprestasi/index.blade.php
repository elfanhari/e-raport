    ...
    <div class="content-header">
                                            ...
                                            <tbody>
                                                @foreach ($prestasi as $item)
                                                    <tr>
                                                        ...
                                                        <td>{{ $item->jenis == 1 ? 'Akademik' : 'Non-Akademik' }}</td>
                                                        <td>
                                                            {{-- <a href="#" type="button"
                                                            ...
                                                            {{-- <a href="{{ route('dataprestasi.edit', $item->id) }}" type="button"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            Data Prestasi: <p class="text-primary fw-bold">
                                                                                {{ $item->siswa->name }}:
                                                                                {{ $item->keterangan }}
                                                                            </p>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('dataprestasi.destroy', ['role' => $role, 'dataprestasi' => $item->id]) }}"
                                                            ...
                                                            <div class="modal fade"
                                                                id="modalGagalDelete/{{ $item->id }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            Data tersebut tidak dapat dihapus! Karena
                                                                            terdapat
                                                                            beberapa siswa di <b>prestasi -
                                                                                {{ $item->name }}</b>
                                                                        </div>
                                                                        <div class="modal-footer">
        ...
        <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <form action="{{ route('dataprestasi.store', $role) }}" method="POST">
                    @csrf

                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title fw-semibold poppins" id="exampleModalLabel">Tambah Data Prestasi
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            @include('pages.dataprestasi._addform')
                        </div>
                        <div class="modal-footer">
