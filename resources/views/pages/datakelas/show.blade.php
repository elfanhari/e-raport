                                                                        ...
                                                                        <div class="table-responsive row col-12">
                                                                            <table>
                                                                                ...
                                                                                <tr class="border-bottom">
                                                                                    ...
                                                                                    <td style="width: 1px;">:</td>
                                                                                    <td>{{ $item->jenispendaftaran == 1 ? 'Siswa Baru' : 'Siswa Pindahan' }}</td>
                                                                                </tr>
                                                                                <tr class="border-bottom">
                                                                                    <td class="fw-bold">Diterima Pada</td>
                                                                                    <td style="width: 1px;">:</td>
                                                                                    <td>{{ date("d-m-Y", strtotime($item->diterimapada))}}</td>
                                                                                  </tr>
                                                                                <tr class="border-bottom">
    ...
    <div class="modal fade" id="importData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title poppins fw-semibold" id="exampleModalLabel">Import Siswa Kelas {{ $kelas->name }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
