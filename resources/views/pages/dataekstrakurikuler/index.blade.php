...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Ekstrakurikuler @can('pembina') Saya @endcan</h1>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            @else
                                <div class="table-responsive">
                                    <table @can('admin') id="table1" @endcan class="table table-sm table-hover ">
                                        <thead>
                                        ...
                                        <tbody>
                                            @foreach ($ekskul as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('dataekstrakurikuler.show', ['dataekstrakurikuler' => $item->id, 'role' => $role]) }}"
                                                        ...
                                                        @can('admin')
                                                        <button data-bs-target="#modalEdit/{{ $item->id }}" data-bs-toggle="modal"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('dataekstrakurikuler.destroy', ['dataekstrakurikuler' => $item->id, 'role' => $role]) }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        beberapa siswa di <b>Ekstrakurikuler -
                                                                            {{ $item->name }}</b>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                        ...
                                                        <div class="modal fade" id="modalEdit/{{ $item->id }}" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog">
                                                                ...
                                                                <form action="{{ route('dataekstrakurikuler.update', ['dataekstrakurikuler' => $item->id, 'role' => $role]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            @include('pages.dataekstrakurikuler._editform')
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="submit"
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form action="{{ route('dataekstrakurikuler.store', ['datapembelajaran' => $item->id, 'role' => $role]) }}" method="POST">
                @csrf

                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fw-semibold poppins" id="exampleModalLabel">Tambah Data Ekstrakurikuler
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        @include('pages.dataekstrakurikuler._addform')
                    </div>
                    <div class="modal-footer">
