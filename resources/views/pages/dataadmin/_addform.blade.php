<div class="row">
  <div class="col-md-6">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="text" value="{{ old('nip') }}" class="form-control @error('nip') is-invalid @enderror " name="nip" id="nip" placeholder="Masukkan nip">
        @error('nip')
        <span class="invalid-feedback mt-1">
          {{ $message }}
        </span>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="text" value="{{ old('nuptk') }}" class="form-control @error('nuptk') is-invalid @enderror " name="nuptk" id="nuptk" placeholder="Masukkan nuptk">
        @error('nuptk')
        <span class="invalid-feedback mt-1">
          {{ $message }}
        </span>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="text" maxlength="12" value="{{ old('telepon') }}" class="form-control @error('telepon') is-invalid @enderror " name="telepon" placeholder="Masukkan telepon">
        @error('telepon')
        <span class="invalid-feedback mt-1">
          {{ $message }}
        </span>
